import {
    ...
    Shield, Warehouse, Users, AlertTriangle
} from 'lucide-react';
...
export const portalConfig: Record<PortalType, PortalConfig> = {
    ADMIN: {
        ...
        navigation: [
            ...
            { id: 'inventory', label: 'Inventory (System)', icon: Package },
            { id: 'suppliers-supplies', label: 'Suppliers & Supplies', icon: ShoppingCart },
    ...
    FARMER: {
        ...
        navigation: [
            ...
            { id: 'suppliers', label: 'Suppliers & Supplies', icon: Package },
